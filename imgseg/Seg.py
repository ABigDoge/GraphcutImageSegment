...
import copy
from imgseg.GMM import GMM
from imgseg.Kmeans import Kmeans
from imgseg.Maxflow import maxflow
...
class seg(object):
    def __init__(self):
        ...
        self.P_fgd=1#may be foreground
        self.P_bgd=2#may be background
        self.GT_fgd=3#ground truth foreground
    ...
    def construct_gcgraph(self,npimg,mask):
        ...
        self.graph = maxflow(vertex_count, edge_count)
        for row in range(rows):
            for col in range(cols):
